...
class OrgFooterLink(I18nModelForm):
    class Meta:
        model = OrganizerFooterLinkModel
        fields = ('label', 'url')


class BaseOrgFooterLinkSet(I18nFormSetMixin, forms.BaseInlineFormSet):
    def __init__(self, *args, **kwargs):
...
OrgFooterLinkset = forms.inlineformset_factory(
    Organizer, OrganizerFooterLinkModel,
    OrgFooterLink,
    formset=OrgFooterLinkSet,

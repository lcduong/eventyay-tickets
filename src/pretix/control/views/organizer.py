...
from pretix.control.forms.organizer import (
    ...
    GiftCardUpdateForm, OrganizerDeleteForm, OrgFooterLink, OrgFooterLinkset, OrganizerForm,
...
class OrganizerUpdate(OrganizerPermissionRequiredMixin, UpdateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        form = self.get_form()
        if form.is_valid() and self.sform.is_valid() and self.footer_links.is_valid():
            return self.form_valid(form)
        else:
            return self.form_invalid(form)
    @cached_property
    def footer_links(self):
        return OrgFooterLinkset(self.request.POST if self.request.method == "POST" else None, 
